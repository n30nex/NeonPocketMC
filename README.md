...
| SenseCAP Indicator D1L | DeskOS touch companion with repeater and room management | [v1.7.8](https://github.com/n30nex/DeskOS-MeshCore/releases/tag/v1.7.8) | Existing DeskOS: app at `0x20000`; fresh install: full 8 MB image at `0x0` |
