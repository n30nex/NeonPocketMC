...
1. Flash `NeonPocketMC-RCC6-Ultimate-Observer-v1.3.0-rc.3-app.bin` at `0x10000`.
...
Manual flasher and upstream integration references are maintained in the dedicated [RCC6 server release documentation](https://github.com/n30nex/NeonPocketMC-RCC6-Repeater/releases/tag/v1.3.0-rc.3).
